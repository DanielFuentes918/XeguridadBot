...
from Utils import envioTemplateTxt, buscar_unitnumber_por_placa,buscar_unitnumber_por_genset, obtener_ultima_transmision, descargar_multimedia, enviar_ubicacion_tile_sync, obtener_ultima_transmision_genset, get_trucks_for_user, buscar_correo_por_telefono
...
def manejar_mensaje_entrante(mensaje):
    ...
    if cuerpo_mensaje.lower() == "xeguridad":
        ...
        estados_a_reiniciar = [
            esperando_denuncia, empresa, denuncia, imagenes, esperando_placa,
            esperando_unit_type, esperando_plate_request, esperando_genset_request,
            esperando_genset, esperando_chasis_request, esperando_chasis
        ]
